...
<h2>Rotation: Tianjin / Qingdao / Shanghai / Ningbo / Nansha / Shekou / Port Kelang / Nhava Sheva / Karachi / Khor Fakkan</h2>
...
with open('voyage_schedule_v2_wait.html', 'w', encoding='utf-8') as f:
    f.write(gen_html(sched_wait,   '(With Waiting Time)', show_waiting=True))

with open('voyage_schedule_v2_nowait.html', 'w', encoding='utf-8') as f:
